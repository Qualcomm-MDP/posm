...
from .api_client import fetch_osm_buildings, fetch_mapillary_metadata
from core.matcher import spatial_join_data

def run_ingestion(lat: float, lon: float, buffer: float = 0.001, output_dir: str = "data/mapillary") -> Dict[str, Any]:
    """
    ...
    results = spatial_join_data(
        osm_raw_json=osm_raw_json,
        mapillary_raw_list=mapillary_raw_list,
        output_dir=out_path
    )
