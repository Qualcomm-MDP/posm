...
def main():
    ...
    # Optional Arguments
    parser.add_argument("--buffer", type=float, default=0.001, help="Bounding box buffer size in degrees")
    parser.add_argument("--output-dir", type=str, default="output", help="Directory to save meshes and data")
